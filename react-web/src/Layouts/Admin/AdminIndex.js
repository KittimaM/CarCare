    ...
    <div className='ml-72 mt-16'>
            <div className='container '>
                    ...
                    <div role="tablist" className="grid tabs tabs-lifted mt-10">
                        ...
                        <input type="radio" name="my_tabs_2" role="tab" className="tab" aria-label="Booking" />
                        <div role="tabpanel" className="tab-content  bg-purple-50 border-base-300 rounded-box p-6">
                            Booking 
                            <table className="table">
                            {/* head */}
                            <thead>
                            ...
                            <tbody>
                                ...
                                <th></th>
                                <th>
                                    <button className="btn bg-blue-300 btn-sm">Edit</button>
                                </th>
                                <th>
                                    <button className="btn bg-red-300 btn-sm">Delete</button>
                                </th>
                                </tr>
