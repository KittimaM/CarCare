  ...
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
        ...
        <div className='bg-gray-100 flex flex-col justify-center'>
            <form onSubmit={handleRegister} className='max-w-[400px] w-full mx-auto bg-white p-4'>
                ...
                <label className="form-control w-full flex flex-col p-2 ">
                    ...
                    <input type="text" name="name" required placeholder="Type here" className="input input-bordered w-full max-w-xs" />                
                </label>
